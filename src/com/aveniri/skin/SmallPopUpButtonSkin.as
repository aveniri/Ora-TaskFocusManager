...
package com.aveniri.skin
{
	 ...
	 */
	public class SmallPopUpButtonSkin extends UIComponent implements IProgrammaticSkin
	{
		 ...
		 *  @productversion Flex 3
		 */
		public function SmallPopUpButtonSkin()
		{
			super();
		...
		override protected function updateDisplayList(w:Number, h:Number):void
		{
			...
			var arrowButtonWidth:Number = 13;//Math.max(getStyle("arrowButtonWidth"), popUpIcon.width + 3 + 1);
			
			var dividerPosX:Number = w - arrowButtonWidth;
			
			popUpIcon.move(w - (arrowButtonWidth + popUpIcon.width) / 2 + 1,
				(h - popUpIcon.height) / 2 + 1);   
			...
			if (popUpIcon is DoubleBtnArrowIcon)
			{			
				//if(getStyle("arrowDirection") != null)				
				//	DoubleBtnArrowIcon(popUpIcon).arrowDirection = arrowDirection;
				
				//DoubleBtnArrowIcon(popUpIcon).arrowSize = arrowSize;
				DoubleBtnArrowIcon(popUpIcon).mx_internal::arrowColor = arrowColor;
			}
			else if (popUpIcon is PopUpIcon)
